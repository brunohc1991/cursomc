...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO entidadeDTO){
		Categoria entidade = service.fromDto(entidadeDTO);
	...
	public ResponseEntity<Void> update(@Valid @RequestBody CategoriaDTO entidadeDTO, @PathVariable Long id){
